...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;500;600;700&family=Syne:wght@500;600;700;800&family=DM+Sans:wght@300;400;500&display=swap" rel="stylesheet" />
...
<body>
  ...
  <section style="background:#fff;padding:80px 32px 64px;border-bottom:1px solid #E5E5E3;">
    <div style="max-width:900px;margin:0 auto;text-align:center;">
      ...
      <h1 style="font-family:'Cormorant Garamond',serif;font-size:clamp(52px,7vw,96px);font-weight:600;color:#111;line-height:0.95;margin-bottom:16px;letter-spacing:-0.01em;">
        Premium brendovi.<br>
  ...
  <div style="background:#F7F7F5;border-bottom:1px solid #E5E5E3;">
    <div style="max-width:1280px;margin:0 auto;display:grid;grid-template-columns:repeat(4,1fr);">
      ...
      <div style="padding:20px 32px;text-align:center;">
        <div style="font-family:'Syne',sans-serif;font-size:22px;font-weight:700;color:#6B21A8;">-50%</div>
