...
export default async function handler(req, res) {
  ...
  try {
    await resend.emails.send({
      ...
      to: process.env.TO_EMAIL || 'almin.revolux@gmail.com',
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;padding:32px 24px;">
          ...
          <div style="background:#1a1a18;padding:20px;text-align:center;border-radius:8px;margin-bottom:24px;">
            <h1 style="color:#C9A96E;font-size:22px;margin:0;letter-spacing:4px;">BAGARDA</h1>
          ...
          <div style="border:1px solid #e8e4df;border-radius:8px;padding:20px;margin-bottom:20px;">
            <div style="font-size:11px;color:#C9A96E;font-weight:700;letter-spacing:2px;margin-bottom:12px;">PROIZVOD</div>
            ...
            ${url ? `<div style="margin-top:12px;"><a href="${url}" style="font-size:13px;color:#C9A96E;font-weight:600;">→ Pogledaj stranicu proizvoda</a></div>` : ''}
          </div>

          <div style="border:1px solid #e8e4df;border-radius:8px;padding:20px;margin-bottom:20px;">
            <div style="font-size:11px;color:#C9A96E;font-weight:700;letter-spacing:2px;margin-bottom:14px;">DOSTAVA</div>
